# =============================================================================
# OWIsMind - TICKETS SEMANTIC MODEL SNAPSHOT (Dataiku notebook, read-only)
# -----------------------------------------------------------------------------
# Exports the LIVE tickets semantic model config to a JSON file so the SQL brain
# is versioned in the repo (entities, metrics, named filters, golden queries,
...
#
# Why a dump instead of a hand-written JSON: the model config is machine state.
# Exporting get_raw() keeps the snapshot byte-faithful to DSS and avoids
# transcription drift. The human-readable view lives in MODEL.md.
#
# Strictly READ-ONLY: never calls save() / set_active / delete.
# =============================================================================
