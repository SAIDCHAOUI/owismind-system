...
**Backend (Python 3.9, dans `OWIsMind_PRD_V1_3_DEV/plugin/owismind/python-lib/owismind/`)**
...
**Orchestrateur (Python 3.11, dans `OWIsMind_PRD_V1_3_DEV/GenAI/Agents/`)**
...
**Catalogue multi-datasets (factory, dans `OWIsMind_PRD_V1_3_DEV/project-library/python/owismind_factory/`)**
...
**Interface (Vue 3, dans `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/src/`)**
...
`OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/owismind-v1_3-upload.zip` (le frontend et `node_modules/` ne sont jamais
...
Copier le contenu de `OWIsMind_PRD_V1_3_DEV/GenAI/Agents/OWIsMind_orchestrator.py` dans l'objet Code Agent
...
- Rapport d'audit securite : `OWIsMind_PRD_V1_3_DEV/docs/SECURITY_AUDIT_2026-07-17_DURABLE.md`
- Runbook de deploiement (phase H) : `OWIsMind_PRD_V1_3_DEV/docs/DEPLOY_V1_3_DEV.md`
- Carte des ids (agents, tools, datasets) : `OWIsMind_PRD_V1_3_DEV/README.md` + `registry.json`
