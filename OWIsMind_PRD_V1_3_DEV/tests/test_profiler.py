...
prof = _load("profiler_under_test",
             "flow/SalesDrive_Revenue_Expert_zone/python-recipes/compute_DRIVE_Revenues_profile.py")
vidx = _load("value_index_under_test",
             "flow/SalesDrive_Revenue_Expert_zone/python-recipes/compute_DRIVE_Revenues_value_index.py")
