...
built-in, [`../GenAI/agents-tools/`](../GenAI/agents-tools/README.md)) as its alias / suggestions fallback.
...
|---|---|---|
| profile | `SalesDrive_Revenue_Expert_zone/python-recipes/compute_DRIVE_Revenues_profile.py` | `CSC_ticket_AI_Agent_zone/python-recipes/compute_TroubleTickets_year_profile.py` |
| value index | `SalesDrive_Revenue_Expert_zone/python-recipes/compute_DRIVE_Revenues_value_index.py` | `CSC_ticket_AI_Agent_zone/python-recipes/compute_TroubleTickets_year_value_index.py` |
| value catalog | `SalesDrive_Revenue_Expert_zone/python-recipes/compute_DRIVE_Revenues_Value_Catalog.py` | `CSC_ticket_AI_Agent_zone/python-recipes/compute_TroubleTickets_year_value_catalogue.py` |
