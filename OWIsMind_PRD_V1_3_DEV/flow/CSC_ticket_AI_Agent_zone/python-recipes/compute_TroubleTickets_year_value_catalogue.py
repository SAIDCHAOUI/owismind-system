...
`attribute_lookup` tool (../../GenAI/agents-tools/, CATALOG_DATASET) reads it as its alias /
...
removed (2026-06-18). Full id map: ../../README.md (OWIsMind_PRD_V1_3_DEV/README.md).
