...
// (distinct load, cascade, sniffing, range mode - a new user chip). The store bumps `n` on
// every request so re-picking the SAME column re-fires this watcher; ignore an absent column.
watch(
  () => evidence.columnFilterRequest,
  (req) => {
