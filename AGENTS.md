...
- Frontend **Vue 3 + Vite** dans `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/`, builde en assets statiques
  servis par DSS (`resource/owismind-app/`, GENERE, jamais edite a la main).
- Backend **Flask DSS modulaire** dans `OWIsMind_PRD_V1_3_DEV/plugin/owismind/python-lib/owismind/`
...
- Agents (Code Agents LangGraph, env 3.11) miroites dans `OWIsMind_PRD_V1_3_DEV/`
...
4. `OWIsMind_PRD_V1_3_DEV/README.md` ou `OWIsMind_LAB/README.md` si tu touches ces zones.
...
- Agents / factory : `python3 -m unittest discover -s OWIsMind_PRD_V1_3_DEV/tests`
- LAB benchmark : `python3 -m unittest discover -s OWIsMind_LAB/project-library/python -t OWIsMind_LAB/project-library/python`
- Backend plugin : `python3 -m unittest discover` depuis `OWIsMind_PRD_V1_3_DEV/plugin/owismind/tests/`
...
3. **Ne jamais editer** `OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/owismind-app/` ni `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/`
