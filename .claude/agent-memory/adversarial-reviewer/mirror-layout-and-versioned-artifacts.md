...
description: OWIsMind agent-mirror now lives at repo root OWIsMind_PRD_V1_2/ (not dataiku-agents/); plugin artifacts are version-derived from plugin.json
metadata:
  type: project
---
...
**Layout.** The agent system is mirrored at repo ROOT under `OWIsMind_PRD_V1_2/`
...
fixes differ (`dataiku-agents/tests/... -> OWIsMind_PRD_V1_2/tests/...`,
`OWISMIND/README.md -> OWIsMind_PRD_V1_2/README.md`, filename mentions). The 3
...
**Version-derived artifacts.** `tools/build_dev_plugin.py` and the `/package-plugin`
