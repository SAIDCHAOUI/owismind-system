...
- OWIsMind repo (corpus `owismind-project-patterns.md`) : `OWIsMind_PRD_V1_3_DEV/GenAI/Agents/OWIsMind_orchestrator.py`, `OWIsMind_PRD_V1_3_DEV/GenAI/Agents/SalesDrive_revenue_expert.py`, `OWIsMind_PRD_V1_3_DEV/tests/` (fichiers historiques renommes, cf. note en tete) ; leçons `memory/LESSONS.md` L047/L048/L050/L051/L052.
