...
| Source Data v3 (Run 2 : backdrop popover, mesures choisies `calcFns`, plages sur colonnes string, cascade distinct POST, persistance des vues `sourceViewMemory`) | ⏳ Validé local (revue 7/7 soldée + QA 8/8 et re-checks 4/4), zip dev_v2 `index-BvJL4hQU.js` à uploader | - | L134-L137 (`sessions/2026-07-06.md` Run 2) |
| Contexte écran -> agent (bandeau consentement, `screen_context.source_state` -> section SOURCE-DATA VIEW du bloc `[ON SCREEN NOW]`, events 41) | ⏳ Validé local ; zip dev_v2 + restart, paragraphe orchestrateur DEV à recoller (env 3.11) | - | L134/L136 (`sessions/2026-07-06.md` Run 2) |
