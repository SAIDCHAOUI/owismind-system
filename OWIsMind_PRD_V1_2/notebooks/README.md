...
| `02_align_clone.py` | Aligne un clone : les modeles semantiques d'un projet duplique pointent encore les tables du projet SOURCE ; remappe tout vers la cle du projet courant | `DRY_RUN = True` d'abord : scan + plan seulement, rien n'est sauve |
