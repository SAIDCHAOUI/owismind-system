# webapps/ - miroir des webapps DSS du projet

Ce dossier est le miroir repo des webapps du projet DSS `OWIsMind_PRD_V1_2`. On edite ici, puis on colle le contenu dans la webapp DSS correspondante.
