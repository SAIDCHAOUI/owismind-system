...
<template>
  <PageShell :eyebrow="t('pj.eyebrow')" :title="t('sb.projects')" :desc="t('pj.desc')">
    <EmptyState bordered icon="folderPlus" :title="t('x.coming_soon')" :tag="t('x.soon')" :desc="t('pj.coming')" />
  </PageShell>
</template>
