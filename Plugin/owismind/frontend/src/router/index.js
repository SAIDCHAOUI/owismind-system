...
// Only the help-menu targets remain generic placeholders now ('/support' got its
// own dedicated view - the Help & Support hub - below).
...
const routes = [
  ...
  // Help & Support hub (feedback + agent-on-data requests, 2 tabs, ?tab= deep-link).
  // '/feedback' is a legacy URL (former inert feedback page) kept as a redirect.
  { path: '/support', name: 'support', component: HelpSupportView, meta: { eyebrow: 'sup.eyebrow', title: 'sup.title' } },
