...
export const extraMessages = {
  fr: {
    ...
    'src.picker.cancel': 'Annuler',
    'src.picker.searchCols': 'Rechercher une colonne…',
    'src.picker.searchVals': 'Filtrer les valeurs…',
    'src.picker.searchHint': 'Entrée : rechercher parmi toutes les valeurs',
    'src.picker.serverFiltered': 'Valeurs filtrées par la recherche. Entrée (champ vide) : tout réafficher',
    'src.picker.error': 'Recherche impossible pour le moment. Réessayez.',
    'src.crunch': 'On fouille les données…',
    'src.picker.noMatch': 'Aucune valeur ne correspond.',
    'src.picker.noColMatch': 'Aucune colonne ne correspond.',
    'src.picker.back': 'Colonnes',
    'src.picker.selected': '{0} sélectionnée(s)',
    'src.cell.use': 'Utiliser pour ma prochaine question',
    'src.cell.filter': 'Filtrer sur cette valeur',
    'src.cell.added': 'Valeur ajoutée à votre prochaine question',
    'src.cell.exists': 'Valeur déjà sélectionnée',
    'src.cell.full': 'Limite de {0} valeurs atteinte',
    'src.cell.tooLong': 'Valeur trop longue pour être envoyée à l\'agent',
    'src.cell.filtered': 'Filtre appliqué',
    'src.cell.filterExists': 'Valeur déjà filtrée',
    'src.cell.filterFull': 'Filtre plein ({0} valeurs max)',
    'src.col.menu': 'Options de colonne',
    'src.col.sortAsc': 'Trier croissant',
    'src.col.sortDesc': 'Trier décroissant',
    'src.col.sortNone': 'Ne plus trier',
    'src.col.filterVals': 'Filtrer les valeurs...',
    'src.col.filterCap': 'Limite de 20 filtres atteinte',
    ...
    'prompt.screen.sent': 'Contexte écran joint à ce message',
    'prompt.screen.view': 'Voir le détail',
    'prompt.screen.d.title': 'Contexte écran envoyé à l\'agent',
    'prompt.screen.d.dataset': 'Jeu de données',
    'prompt.screen.d.agent': 'Agent',
    'prompt.screen.d.filter': 'Filtre',
    'prompt.screen.d.q': 'Recherche',
    'prompt.screen.d.rows': 'Lignes (compte DB)',
    'prompt.screen.d.drill': 'Zoom',
    'prompt.screen.d.calc': 'Calcul',
    'prompt.screen.d.analyze': 'Répartition',
    'prompt.screen.d.truncated': 'top 50 affiché',
    'prompt.screen.d.of': 'de',
    'prompt.screen.d.by': 'par',
    'prompt.screen.d.rowsWord': 'lignes',
    'prompt.screen.d.more': '(+{0} autres)',
  ...
  en: {
    ...
    'src.picker.cancel': 'Cancel',
    'src.picker.searchCols': 'Search columns…',
    'src.picker.searchVals': 'Filter values…',
    'src.picker.searchHint': 'Enter: search all values',
    'src.picker.serverFiltered': 'Values filtered by your search. Enter (empty field): show all again',
    'src.picker.error': 'Search is unavailable right now. Try again.',
    'src.crunch': 'Digging through the data…',
    'src.picker.noMatch': 'No matching value.',
    'src.picker.noColMatch': 'No matching column.',
    'src.picker.back': 'Columns',
    'src.picker.selected': '{0} selected',
    'src.cell.use': 'Use for my next question',
    'src.cell.filter': 'Filter on this value',
    'src.cell.added': 'Value added to your next question',
    'src.cell.exists': 'Value already selected',
    'src.cell.full': 'Limit of {0} values reached',
    'src.cell.tooLong': 'Value too long to send to the agent',
    'src.cell.filtered': 'Filter applied',
    'src.cell.filterExists': 'Value already filtered',
    'src.cell.filterFull': 'Filter full ({0} values max)',
    'src.col.menu': 'Column options',
    'src.col.sortAsc': 'Sort ascending',
    'src.col.sortDesc': 'Sort descending',
    'src.col.sortNone': 'Remove sort',
    'src.col.filterVals': 'Filter values...',
    'src.col.filterCap': 'Filter limit reached (20)',
    ...
    'prompt.screen.sent': 'On-screen context shared with this message',
    'prompt.screen.view': 'View detail',
    'prompt.screen.d.title': 'On-screen context sent to the agent',
    'prompt.screen.d.dataset': 'Dataset',
    'prompt.screen.d.agent': 'Agent',
    'prompt.screen.d.filter': 'Filter',
    'prompt.screen.d.q': 'Search',
    'prompt.screen.d.rows': 'Rows (DB count)',
    'prompt.screen.d.drill': 'Drill',
    'prompt.screen.d.calc': 'Calculation',
    'prompt.screen.d.analyze': 'Breakdown',
    'prompt.screen.d.truncated': 'top 50 shown',
    'prompt.screen.d.of': 'of',
    'prompt.screen.d.by': 'by',
    'prompt.screen.d.rowsWord': 'rows',
    'prompt.screen.d.more': '(+{0} more)',
    'src.loading': 'Loading…',
