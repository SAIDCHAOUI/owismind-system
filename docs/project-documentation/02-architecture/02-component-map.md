...
```mermaid
flowchart TB
  subgraph FE["Vue 3 frontend (OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/src)"]
...
Root: `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/src/`. Stack: Vue 3 (Composition API), Pinia, vue-router in hash
...
Root: `OWIsMind_PRD_V1_3_DEV/plugin/owismind/python-lib/owismind/`. The webapp (`webapps/webapp-owismind-ai-agents/backend.py`)
...
Root: `OWIsMind_PRD_V1_3_DEV/plugin/owismind/python-lib/owismind/storage/`. All application state is persisted in direct SQL
