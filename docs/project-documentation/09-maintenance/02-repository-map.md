...
- `OWIsMind_PRD_V1_3_DEV/plugin/owismind/`: the Dataiku DSS plugin itself (Vue frontend, Flask backend, webapp descriptor,
...
- `docs/project-documentation/`: the structured English documentation set (architecture, backend, frontend,
...
| Versioned generated output (exception) | Produced by a build but TRACKED because it is indispensable for packaging without a reinstall | `OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/owismind-app/` |
| Ignored generated output | Regenerated on demand, never committed | `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/`, `node_modules/`, `graphify-out/`, `__pycache__/` |

The central exception, explained at the top of `.gitignore`: the built frontend
`OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/owismind-app/` IS versioned. The NO INSTALL policy forbids the assistant from
...
## 2. `OWIsMind_PRD_V1_3_DEV/plugin/owismind/`: the DSS plugin

Root of the plugin on disk. The descriptor `OWIsMind_PRD_V1_3_DEV/plugin/owismind/plugin.json` carries `"id": "owismind"` and
...
## 3. `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/`: the Vue SPA
...
## 4. `OWIsMind_PRD_V1_3_DEV/plugin/owismind/webapps/webapp-owismind-ai-agents/`: the DSS webapp component
...
## 5. `OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/`: served resources, including the built frontend
...
## 6. `OWIsMind_PRD_V1_3_DEV/plugin/owismind/tests/`: the pure-logic backend suite
...
usage. Run: `python3 -m unittest discover -s OWIsMind_PRD_V1_3_DEV/plugin/owismind/tests -v`.
...
## 7. `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/`: the packaged deliverable (generated, ignored)
...
Entirely regenerated by the `/package-plugin` skill. The whole `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/` folder is in
...
## 11. `docs/project-documentation/`: the structured English documentation set
