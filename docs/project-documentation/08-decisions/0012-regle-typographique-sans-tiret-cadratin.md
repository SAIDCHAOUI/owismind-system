...
| Documentation (`docs/project-documentation/`, `docs/`) | yes | same |
...
(`OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/owismind-app/`, `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/`, `body.html`), the
