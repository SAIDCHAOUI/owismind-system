...
The OWIsMind frontend is a Vue 3 + Vite SPA, located under `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/`, built into
...
The versions are pinned in `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/package.json`: `vue` `^3.5.34` (Composition API,
...
runner and live OUTSIDE of `src/`, under `OWIsMind_PRD_V1_3_DEV/plugin/owismind/frontend/test/` (never built or zipped). The
