...
To be quoted as-is throughout the documentation (verified in `OWIsMind_PRD_V1_3_DEV/plugin/owismind/plugin.json` and
`OWIsMind_PRD_V1_3_DEV/plugin/owismind/webapps/webapp-owismind-ai-agents/webapp.json`):
...
- **Never edit the generated folders**: `OWIsMind_PRD_V1_3_DEV/plugin/owismind/resource/owismind-app/` and
  `OWIsMind_PRD_V1_3_DEV/plugin/ready-for-dataiku/` are produced by the build and the packaging; you edit the sources
