...
guessed:
  - the literal: OWIsMind_PRD_V1_3_DEV/plugin/owismind/python-lib/owismind/agents/context.py
    build_user_suffix -> ``"⟦owi:mode={0}⟧".format(mode)``
  - the parser:  OWIsMind_PRD_V1_3_DEV/GenAI/Agents/
...
# as its "high" tier (SONNET_ID in OWIsMind_PRD_V1_3_DEV/GenAI/Agents/OWIsMind_orchestrator.py line 104).
# verify on instance
