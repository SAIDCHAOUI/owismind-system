...
(`Plugin/owismind/frontend/`), the LangGraph agents (`dataiku-agents/`), and the benchmark project
...
|---|---|---|---|---|
| Backend | `Plugin/owismind/tests/` | `python3 -m unittest` | repository root | 790 `test_` functions (35 files) |
| Frontend | `Plugin/owismind/frontend/test/` | `node --test` | repository root (via `npm --prefix`) | 352 `test(...)` (18 files) |
